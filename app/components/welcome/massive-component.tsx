  ...
  return (
    <div>
      <div className='flex items-center py-2 text-xl font-medium text-gray-700 rounded-md'>
        <LogoIcon size="large" />
        <span className='ml-2'>{t('app.common.welcome')} {siteInfo.title}</span>
      </div>
